    ...
    public static ILanguage Build(JsonNode data, ApiQueryBuilder builder, string specFlag = null, string @logicOperator = "and")
    {
        ...
        try
        {
            ...
            return @operator switch
            {
                ...
                "eq" => new EqualsInterpreter(data_, builder, @logicOperator),
                ...
                "like" => new ILikeInterpreter(data_, builder, @logicOperator, specFlag),
                ...
                "contains_string" => new BetweenInterpreter(data_, builder, @logicOperator, specFlag),
